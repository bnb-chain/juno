...
func (idx *Indexer) ExportBlock(args ...interface{}) error {
	...
	return idx.ExportEvents(r.TxsResults)

}

// HandleEvent accepts the transaction and handles events contained inside the transaction.
func (idx *Indexer) HandleEvent(index int, event sdk.Event) {
...
func (idx *Indexer) ExportEvents(txs []*abci.ResponseDeliverTx) error {
